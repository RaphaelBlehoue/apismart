 ...
 */
class Version20171005163752 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE users (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', type_id INT DEFAULT NULL, firstname VARCHAR(225) DEFAULT NULL, lastname VARCHAR(225) DEFAULT NULL, INDEX IDX_1483A5E9C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
